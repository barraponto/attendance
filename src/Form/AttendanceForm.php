...
/**
 * Form controller for Attendance edit forms.
 *
 * @ingroup attendance
 */
class AttendanceForm extends ContentEntityForm {
  ...
  /**
   * Constructs a new AttendanceForm.
   *
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        $this->messenger()->addMessage($this->t('Created the %label Attendance.', [
          '%label' => $entity->label(),
        ]));
        break;

      default:
        $this->messenger()->addMessage($this->t('Saved the %label Attendance.', [
          '%label' => $entity->label(),
        ]));
    }
